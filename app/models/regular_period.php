<?php
class RegularPeriod extends AppModel {
	var $name = 'RegularPeriod';
	var $displayField = 'regular_period_name';
	var $validate = array(
		'regular_period_name' => array(
			'notempty' => array(
				'rule' => array('notempty'),
