 ...
 */
	Configure::write('Session.cookie', 'auditbureau');
 ...
 */
	Configure::write('Security.salt', 'DYhh93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mj');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '79859309657453542496749683745');
 ...
 */
	Cache::config('default', array('engine' => 'File'));               
        Configure::write('select_rec_per_page', array('10' => '10', '20' => '20', '50' => '50', '100' => '100', '200' => '200'));
        Configure::write('Routing.prefixes', array('admin', 'client'));