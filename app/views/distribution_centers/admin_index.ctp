...
?><div class="distributionCenters index">
	...
	<tr class="sortHeader">
		...
		<th><?php echo $this->Paginator->sort(__('Distribution Center Id', true), 'DistributionCenter.id');?></th>
		...
		<th><?php echo $this->Paginator->sort(__('Active', true), 'DistributionCenter.active');?></th>
