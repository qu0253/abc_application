<div class="statementANewsprints view">
	...
	<tr>
		...
		<td>:</td>
		<td>
			<?php echo $this->Html->link($statementANewsprint['QualifyingCirculation']['id'], array('controller' => 'qualifying_circulations', 'action' => 'view', $statementANewsprint['QualifyingCirculation']['id'])); ?>
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		...
		<td>
			<?php
			echo $this->AlaxosHtml->get_active_inactive($statementANewsprint['StatementANewsprint']['active']);
			?>
		</td>
	</tr>
	<tr>
		...
		<td>:</td>
		<td>
			<?php echo DateTool :: sql_to_date($statementANewsprint['StatementANewsprint']['created']); ?>
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>:</td>
		<td>
			<?php echo $this->Html->link($statementANewsprint['CreatedBy']['username'], array('controller' => 'users', 'action' => 'view', $statementANewsprint['CreatedBy']['id'])); ?>
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>:</td>
		<td>
			<?php echo DateTool :: sql_to_date($statementANewsprint['StatementANewsprint']['modified']); ?>
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>:</td>
		<td>
			<?php echo $this->Html->link($statementANewsprint['ModifiedBy']['username'], array('controller' => 'users', 'action' => 'view', $statementANewsprint['ModifiedBy']['id'])); ?>
		</td>
	</tr>
	</table>
</div>
