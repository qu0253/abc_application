...
?><div class="rniDetails index">
	...
	<tr class="sortHeader">
		...
		<th><?php echo $this->Paginator->sort(__('Active', true), 'RniDetail.active');?></th>
	...
	<tr class="searchHeader">
		...
		<td>
			<?php
				echo $this->AlaxosForm->filter_field('rni_number');
			?>
		</td>
		<td>
			<?php
				echo $this->AlaxosForm->filter_field('file_rni_document');
			?>
		</td>
		<td>
			<?php
		...
		<td class="searchHeader">
    		...
    		<?php
			echo $this->AlaxosForm->create('RniDetail', array('id' => 'chooseActionForm', 'url' => array('controller' => 'rniDetails', 'action' => 'actionAll')));
			?>
    	</td>
	</tr>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link($this->Html->image('/alaxos/img/toolbar/small_edit.png'), array('action' => 'edit', $rniDetail['RniDetail']['id']), array('escape' => false, 'title' => 'Edit')); ?>
			<?php echo $this->Html->link($this->Html->image('/alaxos/img/toolbar/copy.png'), array('action' => 'copy', $rniDetail['RniDetail']['id']), array('escape' => false, 'title' => 'Copy')); ?>
			<?php echo $this->Html->link($this->Html->image('/alaxos/img/toolbar/small_drop.png'), array('action' => 'delete', $rniDetail['RniDetail']['id']), array('escape' => false, 'title' => 'Delete'), sprintf(___("are you sure you want to delete '%s' ?", true), $rniDetail['RniDetail']['rni_number'])); ?>
...
?>
	...
	echo $this->AlaxosForm->create('RniDetail', array('url' => $passedArgs, 'id' => 'SelectRecPerPage', 'class' => 'SelectRecPerPage')); //'url' => $this->passedArgs allows to keep the sort when searching
