...
<!--		<th><?php echo $this->Paginator->sort(__('Date Of First Issue', true), 'Membership.date_of_first_issue');?></th>-->
		...
		<th><?php echo $this->Paginator->sort(__('File Pub Confr Letter', true), 'file_pub_confr_letter');?></th>
		<th><?php echo $this->Paginator->sort(__('File Letter Of Auth', true), 'file_letter_of_auth');?></th>
		...
		<th><?php echo $this->Paginator->sort(__('Active', true), 'Membership.active');?></th>
...
<!--		<td>
		...
		<td>
			<?php
				echo $this->AlaxosForm->filter_field('file_pub_confr_letter');
			?>
		</td>
		<td>
			<?php
				echo $this->AlaxosForm->filter_field('file_letter_of_auth');
			?>
		</td>
		<td>
			<?php
...
<!--		<td>
		...
		<td>
                        <?php
			$file_name = $membership['Membership']['file_pub_confr_letter'];
			if (!empty($file_name)) {
				echo $this->AlaxosForm->get_download_link($membership['Membership']['file_pub_confr_letter'], 'memberships', $membership['Membership']['id'], 'file_pub_confr_letter');
			} ?>
		</td>
		<td>
                        <?php
			$file_name = $membership['Membership']['file_letter_of_auth'];
			if (!empty($file_name)) {
				echo $this->AlaxosForm->get_download_link($membership['Membership']['file_letter_of_auth'], 'memberships', $membership['Membership']['id'], 'file_letter_of_auth');
			} ?>
		</td>
		<td>
