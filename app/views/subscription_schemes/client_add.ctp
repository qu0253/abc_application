<div class="subscriptionSchemes form">
	...
	<?php echo $this->AlaxosForm->create('SubscriptionScheme', array('enctype' => 'multipart/form-data', 'action' => 'client_add', 'id' => 'SubscriptionSchemeClientAddForm'));?>
	<div class="h2bg"><span class="h2-left"></span>
	    <span class="h2-center">
		<h3><?php ___('client add subscription scheme'); ?></h3>
	    </span>
	...
	<tr class="display_none">
		...
		<td>
			<?php 
                            echo $saleTypes[$this->data['SubscriptionScheme']['sale_type_id']]; 
