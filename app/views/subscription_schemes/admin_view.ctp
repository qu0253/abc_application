<div class="subscriptionSchemes view">
	...
	<tr>
		...
		<td>:</td>
		<td>
			<?php echo $this->Html->link($subscriptionScheme['QualifyingCirculation']['id'], array('controller' => 'qualifying_circulations', 'action' => 'view', $subscriptionScheme['QualifyingCirculation']['id'])); ?>
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>:</td>
		<td>
			<?php echo $this->Html->link($subscriptionScheme['SaleType']['sale_type_name'], array('controller' => 'sale_types', 'action' => 'view', $subscriptionScheme['SaleType']['id'])); ?>
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		...
		<td>
			<?php
			echo $this->AlaxosHtml->get_active_inactive($subscriptionScheme['SubscriptionScheme']['active']);
			?>
		</td>
	</tr>
	<tr>
		...
		<td>:</td>
		<td>
			<?php echo DateTool :: sql_to_date($subscriptionScheme['SubscriptionScheme']['created']); ?>
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>:</td>
		<td>
			<?php echo $this->Html->link($subscriptionScheme['CreatedBy']['username'], array('controller' => 'users', 'action' => 'view', $subscriptionScheme['CreatedBy']['id'])); ?>
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>:</td>
		<td>
			<?php echo DateTool :: sql_to_date($subscriptionScheme['SubscriptionScheme']['modified']); ?>
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>:</td>
		<td>
			<?php echo $this->Html->link($subscriptionScheme['ModifiedBy']['username'], array('controller' => 'users', 'action' => 'view', $subscriptionScheme['ModifiedBy']['id'])); ?>
		</td>
	</tr>
	</table>
</div>
