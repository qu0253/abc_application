<div class="whiteForms view">
	...
	<?php
	echo $this->element('toolbar/toolbar', array('plugin' => 'alaxos', 'add' => true, 'list' => true, 'edit_id' => $whiteForm['WhiteForm']['id'], 'copy_id' => $whiteForm['WhiteForm']['id'], 'delete_id' => $whiteForm['WhiteForm']['id'], 'delete_text' => ___('do you really want to delete this white form ?', true)));
	?>
