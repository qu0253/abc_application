<div class="nonQualifyingCirculations form">
	...
	<div class="h2bg"><span class="h2-left"></span>
		...
		<h2><?php ___('client add non qualifying circulation'); ?></h2>
	    </span>
	...
	<tr class="row50">
		...
		<td>
			<?php echo $this->AlaxosForm->input('input_disabled', array('label' => false, 'disabled' => 'disabled', 'class' => 'highlighted', 'tabindex' => '-1')); ?>
		</td>
