<div class="regularPeriods form">
	...
	<div class="h2bg"><span class="h2-left"></span>
		...
		<h2><?php ___('admin add regular period'); ?></h2>
	    </span>
	...
	<tr>
		...
		<td>*:</td>
		<td>
			<?php echo $this->AlaxosForm->input('regular_period_name', array('label' => false, 'readonly' => 'readonly')); ?>
		</td>
	</tr>
                	<tr>
		<td>
		...
		<td>*:</td>
		<td>
			<?php echo $this->AlaxosForm->input('volume_number', array('label' => false, 'readonly' => 'readonly')); ?>
		</td>
	</tr>
                	<tr>
		<td>
		...
		<td>*:</td>
		<td>
			<?php echo $this->AlaxosForm->input('from_date', array('label' => false, 'readonly' => 'readonly')); ?>
		</td>
	</tr>
                	<tr>
		<td>
		...
		<td>*:</td>
		<td>
			<?php echo $this->AlaxosForm->input('to_date', array('label' => false, 'readonly' => 'readonly')); ?>
		</td>
	</tr>
                	<tr>
		<td>
