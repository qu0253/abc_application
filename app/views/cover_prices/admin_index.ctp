...
?><div class="coverPrices index">
	...
	<tr class="sortHeader">
		...
		<th><?php echo $this->Paginator->sort(__('Cover Price Id', true), 'CoverPrice.id');?></th>
		...
		<th><?php echo $this->Paginator->sort(__('Active', true), 'CoverPrice.active');?></th>
