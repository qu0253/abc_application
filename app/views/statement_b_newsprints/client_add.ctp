<div class="statementBNewsprints form">
	...
	<?php echo $this->AlaxosForm->create('StatementBNewsprint', array('enctype' => 'multipart/form-data', 'action' => 'add', 'id' => 'StatementBNewsprintClientAddForm'));?>
	<div class="h2bg"><span class="h2-left"></span>
	    <span class="h2-center">
		<h3><?php ___('client add statement b newsprint'); ?></h3>
	    </span>
